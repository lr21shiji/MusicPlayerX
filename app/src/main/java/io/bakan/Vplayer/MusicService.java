...
import io.bakan.Vplayer.mvp.model.MusicPlaybackTrack;
import io.bakan.Vplayer.permission.PermissionManager;
import io.bakan.Vplayer.provider.MusicPlaybackState;
import io.bakan.Vplayer.provider.RecentStore;
import io.bakan.Vplayer.provider.SongPlayCount;
import io.bakan.Vplayer.receiver.MediaButtonIntentReceiver;
import io.bakan.Vplayer.util.ATEUtil;
import io.bakan.Vplayer.util.ListenerUtil;
import io.bakan.Vplayer.util.NavigationUtil;

@SuppressLint("NewApi")
public class MusicService extends Service {

    public static final String PLAYSTATE_CHANGED = "io.bakan.Surprise.playstatechanged";
    public static final String POSITION_CHANGED = "io.bakan.Surprise.positionchanged";
    public static final String META_CHANGED = "io.bakan.Surprise.metachanged";
    public static final String QUEUE_CHANGED = "io.bakan.Surprise.queuechanged";
    public static final String PLAYLIST_CHANGED = "io.bakan.Surprise.playlistchanged";
    public static final String REPEATMODE_CHANGED = "io.bakan.Surprise.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "io.bakan.Surprise.shufflemodechanged";

    public static final String TRACK_ERROR = "io.bakan.Surprise.trackerror";
    public static final String LISTENER_PACKAGE_NAME = "io.bakan.Surprise";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";

    public static final String SERVICECMD = "io.bakan.Surprise.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "io.bakan.Surprise.togglepause";
    public static final String PAUSE_ACTION = "io.bakan.Surprise.pause";
    public static final String STOP_ACTION = "io.bakan.Surprise.stop";
    public static final String PREVIOUS_ACTION = "io.bakan.Surprise.previous";
    public static final String PREVIOUS_FORCE_ACTION = "io.bakan.Surprise.previous.force";
    public static final String NEXT_ACTION = "io.bakan.Surprise.next";
    public static final String REPEAT_ACTION = "io.bakan.Surprise.repeat";
    public static final String SHUFFLE_ACTION = "io.bakan.Surprise.shuffle";

    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "io.bakan.Surprise.refresh";
    ...
    private static final String SHUTDOWN = "io.bakan.Surprise.shutdown";
